...
[![Build Status](https://travis-ci.org/helmesjo/conan-aeron.svg?branch=stable%2F1.15.3)](https://travis-ci.org/helmesjo/conan-aeron)
[![Build status](https://ci.appveyor.com/api/projects/status/github/helmesjo/conan-aeron?branch=stable%2F1.15.3&svg=true)](https://ci.appveyor.com/project/helmesjo/conan-aeron)
...
### Basic setup
    ...
    $ conan install aeron/1.15.3@helmesjo/stable
...
## Upload
    ...
    $ conan upload aeron/1.15.3@helmesjo/stable --all -r helmesjo
...
[MIT](https://github.com/helmesjo/conan-aeron.git/blob/testing/1.15.3/LICENSE)
